			...
			<div class="container">
				...
				<div style="margin-right: 130px;">
					...
					<div
						...
						<a href="javascript:;" id="clear" class="clear" onclick="clearCart()">清空购物车</a> <a
							href="${pageContext.request.contextPath }/product?method=submitOrder"> <input type="submit" width="100"
